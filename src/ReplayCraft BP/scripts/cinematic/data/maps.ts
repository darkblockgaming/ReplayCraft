import { uiState, FrameData, SettingsData, OtherData } from "./types/types";

export const uiStateMap: Map<string, uiState> = new Map();
export const frameDataMap: Map<string, FrameData[]> = new Map();
export const settingsDataMap: Map<string, SettingsData> = new Map();
export const otherDataMap: Map<string, OtherData> = new Map();
