...
<p align="center">
ReplayCraft now utilizes the <b>2.8.0-Beta server</b> and <b>2.1.0-Beta server-ui APIs</b>, enhancing compatibility and performance for Minecraft Bedrock.
</p>
...
# [Download v3.1.5](https://github.com/darkblockgaming/ReplayCraft/releases)
### For Minecraft Bedrock 1.26.20

---

## ⬇️ 3.1.5 Changelog
# [View Changelog](https://github.com/darkblockgaming/ReplayCraft/releases/tag/v3.1.5)
